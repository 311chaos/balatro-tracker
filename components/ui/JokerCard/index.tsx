...
export const JokerCard = ({ joker, stickerLevel, onToggle }: Props) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="flex cursor-pointer flex-col items-center gap-2 rounded-lg bg-black/20 p-3 transition-colors hover:bg-black/35 focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:outline-none"
